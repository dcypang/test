...
function buildHomeRoute(gl) {
  ...
  // The interstate network: three running east-west, one along each row, and
  // four running north-south. Real numbers on roughly the right ground - I-90
  // across the north, I-80 through the middle, I-40 along the south, I-5 down
  // the west coast, I-25 through the mountain states, I-29 out east - because a
  // highway you recognise tells you where you are before the sign does.
  //
